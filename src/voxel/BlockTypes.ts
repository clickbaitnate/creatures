...
export const BLOCK_PROPS: BlockProps[] = [
  ...
  /* Grass        */ { color: 0x4CAF50, solid: true,  transparent: false, mineable: true,  mineYield: ItemType.RawGrass, mineTicks: 15, emissive: false },
  /* Stone        */ { color: 0x808080, solid: true,  transparent: false, mineable: true,  mineYield: ItemType.RawStone, mineTicks: 40, emissive: false },
  ...
  /* Wood         */ { color: 0x8B5A2B, solid: true,  transparent: false, mineable: true,  mineYield: ItemType.RawWood,  mineTicks: 30, emissive: false },
  ...
  /* Mushroom     */ { color: 0xCC3344, solid: false, transparent: true,  mineable: true,  mineYield: null,              mineTicks: 2,  emissive: false },
  /* TallGrass    */ { color: 0x6B8E23, solid: false, transparent: true,  mineable: true,  mineYield: ItemType.RawGrass, mineTicks: 3,  emissive: false },
  /* BerryBush    */ { color: 0x228B22, solid: true,  transparent: false, mineable: true,  mineYield: ItemType.RawBerry, mineTicks: 12, emissive: false },
